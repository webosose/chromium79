...
RootWindowController::RootWindowController(
  ...
  host_->SetNativeEventDelegate(this);
#endif
...
RootWindowController::~RootWindowController() {
#if defined(USE_NEVA_APPRUNTIME)
  host_->SetNativeEventDelegate(NULL);
#endif
...
#if defined(USE_NEVA_APPRUNTIME)
void RootWindowController::WindowHostClose() {
  OnHostCloseRequested(host_.get());
}

void RootWindowController::CompositorBuffersSwapped() {
}

void RootWindowController::CursorVisibilityChanged(bool visible) {
}

void RootWindowController::InputPanelVisibilityChanged(bool visible) {
}

void RootWindowController::InputPanelRectChanged(int32_t x,
                           int32_t y,
                           uint32_t width,
                           uint32_t height) {
}

void RootWindowController::KeyboardEnter() {
}

void RootWindowController::KeyboardLeave() {
}

void RootWindowController::WindowHostExposed() {
}

void RootWindowController::WindowHostStateChanged(ui::WidgetState new_state) {
}

void RootWindowController::WindowHostStateAboutToChange(ui::WidgetState state) {
}
#endif
