...
void SampleImpl::AddBinding(mojom::SampleRequest request) {
...
void SampleImpl::Subscribe(SubscribeCallback callback) {
  mojom::SampleListenerAssociatedPtr listener;
  mojom::SampleListenerAssociatedRequest request =
...
void SampleImpl::DataUpdated(const std::string& url,
  ...
  if (url == kSample_sampleUpdate) {
    listeners_.ForAllPtrs(
        [&data](mojom::SampleListener* listener) {
