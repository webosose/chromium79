...
class SampleImpl : public mojom::Sample
 ...
 public:
  ...
  void AddBinding(mojom::SampleRequest request);
 ...
 private:
  ...
  mojo::BindingSet<mojom::Sample> bindings_;
  ...
  mojo::AssociatedInterfacePtrSet<mojom::SampleListener> listeners_;

  DISALLOW_COPY_AND_ASSIGN(SampleImpl);
};
