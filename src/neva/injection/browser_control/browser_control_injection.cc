...
class BrowserControlInjection : public gin::Wrappable<BrowserControlInjection>,
 ...
 public:
  ...
  BrowserControlInjection(blink::WebLocalFrame* frame);
...
// static
void BrowserControlInjectionExtension::Install(
...
void BrowserControlInjectionExtension::Uninstall(blink::WebLocalFrame* frame) {
  v8::Isolate* isolate = blink::MainThreadIsolate();
  v8::HandleScope handle_scope(isolate);
  v8::Local<v8::Context> context = frame->MainWorldScriptContext();
  if (context.IsEmpty())
...
// static
v8::MaybeLocal<v8::Object> BrowserControlInjectionExtension::CreateObject(
    blink::WebLocalFrame* frame,
    v8::Isolate* isolate,
