...
#ifndef NEVA_INJECTION_WEBOSSERVICEBRIDGE_WEBOSSERVICEBRIDGE_PROPERTIES_H_
#define NEVA_INJECTION_WEBOSSERVICEBRIDGE_WEBOSSERVICEBRIDGE_PROPERTIES_H_
...
#endif  // NEVA_INJECTION_WEBOSSERVICEBRIDGE_WEBOSSERVICEBRIDGE_PROPERTIES_H_
