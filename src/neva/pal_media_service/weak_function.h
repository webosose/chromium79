...
#ifndef NEVA_PAL_MEDIA_SERVICE_NEVA_WEBOS_WEAK_FUNCTION_H_
#define NEVA_PAL_MEDIA_SERVICE_NEVA_WEBOS_WEAK_FUNCTION_H_
...
#endif  // NEVA_PAL_MEDIA_SERVICE_NEVA_WEBOS_WEAK_FUNCTION_H_
