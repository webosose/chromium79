...
#ifndef NEVA_PAL_MEDIA_SERVICE_NEVA_WEBOS_SYSTEM_MEDIA_MANAGER_GMP_H_
#define NEVA_PAL_MEDIA_SERVICE_NEVA_WEBOS_SYSTEM_MEDIA_MANAGER_GMP_H_
...
#endif  // NEVA_PAL_MEDIA_SERVICE_NEVA_WEBOS_SYSTEM_MEDIA_MANAGER_GMP_H_
