...
#ifndef NEVA_PAL_MEDIA_SERVICE_WEBOS_UMEDIA_INFO_UTIL_WEBOS_GMP_H_
#define NEVA_PAL_MEDIA_SERVICE_WEBOS_UMEDIA_INFO_UTIL_WEBOS_GMP_H_
...
#endif  // NEVA_PAL_MEDIA_SERVICE_WEBOS_UMEDIA_INFO_UTIL_WEBOS_GMP_H_
