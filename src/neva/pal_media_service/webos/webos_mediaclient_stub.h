...
#ifndef NEVA_PAL_MEDIA_SERVICE_WEBOS_WEBOS_MEDIACLIENT_STUB_H_
#define NEVA_PAL_MEDIA_SERVICE_WEBOS_WEBOS_MEDIACLIENT_STUB_H_
...
#endif  // NEVA_PAL_MEDIA_SERVICE_WEBOS_WEBOS_MEDIACLIENT_STUB_H_
