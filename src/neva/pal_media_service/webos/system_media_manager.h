...
#ifndef NEVA_PAL_MEDIA_SERVICE_NEVA_WEBOS_SYSTEM_MEDIA_MANAGER_H_
#define NEVA_PAL_MEDIA_SERVICE_NEVA_WEBOS_SYSTEM_MEDIA_MANAGER_H_
...
#endif  // NEVA_PAL_MEDIA_SERVICE_NEVA_WEBOS_SYSTEM_MEDIA_MANAGER_H_
