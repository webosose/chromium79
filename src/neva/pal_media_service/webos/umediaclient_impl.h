...
#ifndef NEVA_PAL_MEDIA_SERVICE_NEVA_WEBOS_UMEDIACLIENT_IMPL_H_
#define NEVA_PAL_MEDIA_SERVICE_NEVA_WEBOS_UMEDIACLIENT_IMPL_H_
...
#endif  // NEVA_PAL_MEDIA_SERVICE_NEVA_WEBOS_UMEDIACLIENT_IMPL_H_
