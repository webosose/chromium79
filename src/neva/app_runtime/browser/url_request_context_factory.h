...
class URLRequestContextFactory {
 public:
  ...
  net::NetworkDelegate* app_network_delegate() const {
 ...
 private:
  ...
  std::unique_ptr<net::NetworkDelegate> app_network_delegate_;
  std::unique_ptr<net::NetworkDelegate> system_network_delegate_;
