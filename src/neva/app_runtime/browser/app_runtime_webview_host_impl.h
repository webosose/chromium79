...
class AppRuntimeWebViewHostImpl : public mojom::AppRuntimeWebViewHost,
 ...
 public:
  ...
  void DecidePolicyForResponse(
      ...
      DecidePolicyForResponseCallback callback) override;
  void DidNonFirstMeaningPaintAfterLoad() override;

 private:
  content::WebContentsFrameBindingSet<mojom::AppRuntimeWebViewHost>
      webview_host_bindings_;
  content::WebContentsFrameBindingSet<blink::mojom::AppRuntimeBlinkDelegate>
      blink_delegate_bindings_;
