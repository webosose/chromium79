...
#ifndef UI_PLATFORM_WINDOW_NEVA_PLATFORM_WINDOW_BASE_H_
#define UI_PLATFORM_WINDOW_NEVA_PLATFORM_WINDOW_BASE_H_
...
// additions for platform window base.
class PlatformWindowBase {
 public:
...
#endif  // UI_PLATFORM_WINDOW_NEVA_PLATFORM_WINDOW_BASE_H_
