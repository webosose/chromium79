...
#ifndef UI_PLATFORM_WINDOW_NEVA_MOJO_VIDEO_WINDOW_INFO_MOJOM_TRAITS_H_
#define UI_PLATFORM_WINDOW_NEVA_MOJO_VIDEO_WINDOW_INFO_MOJOM_TRAITS_H_
#include <string>
...
#endif  // UI_PLATFORM_WINDOW_NEVA_MOJO_VIDEO_WINDOW_INFO_MOJOM_TRAITS_H_
