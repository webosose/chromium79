...
class MEDIA_BLINK_EXPORT WebMediaPlayerWebRtc
 ...
 private:
  ...
  void InitMediaPlatformAPI(const scoped_refptr<media::VideoFrame>& input_frame);
  ...
  VideoDecoderConfig GetVideoConfig(media::VideoPixelFormat format);
  ...
  DISALLOW_COPY_AND_ASSIGN(WebMediaPlayerWebRtc);
};
