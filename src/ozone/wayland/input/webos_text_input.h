...
class WaylandTextInput {
 ...
 private:
  ...
  struct InputPanel {
    InputPanel();
    InputPanel(text_model* t_model, WaylandSeat* w_seat, unsigned window_handle);
    ~InputPanel();
    ...
    ui::InputContentType input_content_type =
        ui::InputContentType::INPUT_CONTENT_TYPE_NONE;
