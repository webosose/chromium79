...
// We need to keep the chrome dependency here because our base is
// views::LinuxUI class that indirectly depends on chrome component
// via NavButtonProvider function parameter. NavButtonProvider is
// defined in 'chrome/browser/ui/views/nav_button_provider.h' header.
...
bool OzoneWebUI::GetColor(int id,
                          SkColor* color,
...
void OzoneWebUI::SetNativeThemeOverride(NativeThemeGetter callback) {}
